...
if(DAO.OBS.get('StartOnApp') == null){
    setTimeout(async ()=>{
        await DAO.OBS.set('StartOnApp', false);
    })
}
...
document.getElementById('obs-checkbox-start').checked = DAO.OBS.get('StartOnApp');
...
$(document).ready(async function(){
    ...
    $('#obs-checkbox-start').click(async function(){
        ...
        await DAO.OBS.set('StartOnApp', isCheck);
    });
